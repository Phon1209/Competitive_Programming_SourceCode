...
NORETURN void InStream::quit(TResult result, const char* msg)
{
    ...
    if (result == _ok) {
        ...
        std::fprintf(stderr, "Output is correct\n");
    } else if (result == _wa) {
        std::fprintf(stdout, "0.0\n");
        std::fprintf(stderr, "Output isn't correct\n");
    } else if (result == _pe) {
        std::fprintf(stdout, "0.0\n");
        std::fprintf(stderr, "Output isn't correct\n");
        ...
        std::fprintf(stderr, "Output is partially correct\n");
    } else {
        std::fprintf(stdout, "0.0\n");
        std::fprintf(stderr, "Judge system error. Contact problem author.\n");
        halt(1);
    }
...
void registerInteraction(int argc, char* argv[])
{
    ...
    tout.open("/dev/stdout", std::ios_base::out);
